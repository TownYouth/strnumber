...
test('常规场景', () => {
  expect(into(100, 25)).toBe('4')
  expect(into(1, 3)).toBe(
    '0.3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333'
  )
  expect(into(-15, 5)).toBe('-3')
  expect(into(0, 5)).toBe('0')
  expect(into(999.999, 0.001)).toBe('999999')
  expect(into(22, 7)).toBe(
    '3.1428571428571428571428571428571428571428571428571428571428571428571428571428571428571428571428571429'
  )
  expect(into(5, 0)).toBe(strNumber.POSITIVE_INFINITY)
})
...
test('大整数相除', () => {
  ...
  expect(into('1234567890123456789', '1234567890123456788')).toBe(
    '1.0000000000000000008100000072900000670032006155676056553539559569618853398657723047663935274666701114'
  )
  expect(into('-1234567890123456789', '1234567890123456788')).toBe(
    '-1.0000000000000000008100000072900000670032006155676056553539559569618853398657723047663935274666701114'
  )
